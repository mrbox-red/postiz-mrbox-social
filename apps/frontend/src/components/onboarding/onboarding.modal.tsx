      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'No MCP or CLI settings needed. Paste this into the chat, the agent installs the Mr Box Social CLI and asks you for your API key.'
          )}
        </div>
      </div>
        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Use the Mr Box Social API from your own code, n8n or any other automation'
            )}
          </div>
        </div>
        <a
      ...
      <div>
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'The fastest way: add Mr Box Social with one click, you will be asked to sign in'
          )}
        </div>
      </div>
      <a
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Give your agent Mr Box Social tools to create, schedule and manage posts'
          )}
        </div>
      </div>
        ...
        <div className="flex flex-col gap-[6px]">
          ...
          <div className="flex gap-[6px]">
            {(['oauth', 'apikey'] as const).map((m) => (
              ...
              >
                {m === 'oauth'
                  ? t('sign_in_no_api_key', 'Sign in with Mr Box Social (no API key)')
                  : t('api_key', 'API Key')}
              </button>
            ))}
          </div>
        ...
        <div className="flex flex-col gap-[8px]">
          <div className="text-[12px] text-customColor18 font-[500]">
            ...
            {auth === 'oauth' &&
              ` ${t(
                'oauth_sign_in_hint',
                'Your agent will open a browser window to sign in to Mr Box Social.'
              )}`}
          </div>
          <pre className="bg-newBgColorInner border border-newBorder rounded-[8px] p-[12px] text-[12px] whitespace-pre-wrap break-all overflow-x-auto leading-[1.5]">
            {maskedConfig}
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Install the Mr Box Social CLI and the skill that teaches your agent how to use it'
          )}
        </div>
      </div>
...
const OnboardingStep3: FC<{ onBack: () => void; onFinish: () => void }> = ({
  ...
  return (
    <div className="flex flex-col gap-[24px] flex-1">
      <div className="flex gap-[4px] flex-col text-center">
        <div className="text-[24px] font-semibold">
          {t('watch_tutorial_title', 'Learn How to Use Mr Box Social')}
        </div>
        <div className="text-[14px] text-customColor18">
          {t(
            'watch_tutorial_description',
            'Watch this short video to learn how to get the most out of Mr Box Social'
          )}
        </div>
      </div>
